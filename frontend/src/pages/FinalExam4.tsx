...
export default function FinalExam4() {
  ...
  const questions = useFinalExam(4)
  ...
  const handleNext = () => {
    if (current < questions.length - 1) {
      ...
      setFinished(true)
      useProgressStore.getState().submitExamScore('examen-programme-4', finalPct)
      ...
      <div style={{ paddingTop: 56 }}>
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '60px 24px 80px' }}>
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} style={{ textAlign: 'center' }}>
            ...
            }}>{t('// examen programme 4', '// program 4 exam')}</div>

            <h1 style={{
              fontFamily: 'var(--font-heading)', fontSize: 36, fontWeight: 700,
              letterSpacing: '-1px', marginBottom: 16,
            }}>{t('Examen - Programme 4', 'Exam - Program 4')}</h1>
            ...
            <p style={{
              ...
              {t(
                '50 questions sur QoS, IPv6 avance, MPLS, BGP avance, Wireless avance, Datacenter, SD-WAN et cybersecurite.',
                '50 questions on QoS, Advanced IPv6, MPLS, Advanced BGP, Advanced Wireless, Datacenter, SD-WAN and cybersecurity.'
              )}
            </p>
            ...
            <button onClick={() => setStarted(true)} style={{
              padding: '14px 36px', background: accentColor, color: 'var(--bg-primary)',
  ...
  if (finished || timeUp) {
    ...
    const chapterNames = ['QoS', t('IPv6 Av.', 'IPv6 Adv.'), 'MPLS', t('BGP Av.', 'BGP Adv.'), t('WiFi Av.', 'WiFi Adv.'), 'Datacenter', 'SD-WAN', t('Cybersec', 'Cybersec')]
    const ranges = [[0, 6], [6, 12], [12, 19], [19, 25], [25, 31], [31, 38], [38, 44], [44, 50]]
        ...
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '40px 24px 80px' }}>
          <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }}>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
              ...
              <Link to="/progression">
                <button style={{
                  padding: '10px 20px', background: accentColor, color: 'var(--bg-primary)',
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontFamily: 'var(--font-heading)', fontSize: 15, fontWeight: 600 }}>{t('Examen Programme 4', 'Exam Program 4')}</span>
          </div>
          ...
          <motion.div key={current} initial={{ opacity: 0, x: 12 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -12 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              {order.map((originalIdx, displayIdx) => {
                ...
                } else if (isThisSelected) { bg = 'rgba(225, 29, 72, 0.1)'; border = accentColor }
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 24 }}>
              {!showResult ? (
                ...
                <button onClick={handleNext} style={{
                  padding: '10px 24px', background: accentColor, color: 'var(--bg-primary)',
