...
export default function FinalExam6() {
  ...
  const questions = useFinalExam(6)
  ...
  const handleNext = () => {
    if (current < questions.length - 1) {
      ...
      setFinished(true)
      useProgressStore.getState().submitExamScore('examen-programme-6', finalPct)
      ...
      <div style={{ paddingTop: 56 }}>
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '60px 24px 80px' }}>
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} style={{ textAlign: 'center' }}>
            ...
            }}>{t('// examen programme 6', '// program 6 exam')}</div>

            <h1 style={{
              fontFamily: 'var(--font-heading)', fontSize: 36, fontWeight: 700,
              letterSpacing: '-1px', marginBottom: 16,
            }}>{t('Examen - Programme 6', 'Exam - Program 6')}</h1>
            ...
            <p style={{
              ...
              {t(
                '50 questions sur l\'automatisation, SDN, APIs REST, gestion de config, AI/ML reseaux et JSON.',
                '50 questions on automation, SDN, REST APIs, config management, AI/ML networking and JSON.'
              )}
            </p>
            ...
            <div style={{
              ...
              {[
                ...
                { label: t('Chapitres', 'Chapters'), value: '7', icon: <GraduationCap size={16} /> },
  ...
  if (finished || timeUp) {
    ...
    const chapterNames = [t('Impact Auto.', 'Automation Impact'), t('Trad. vs Ctrl', 'Trad. vs Ctrl'), 'SDN', 'AI/ML', 'APIs REST', t('Outils Config', 'Config Tools'), 'JSON']
    const ranges = [[0, 7], [7, 14], [14, 21], [21, 28], [28, 36], [36, 43], [43, 50]]
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontFamily: 'var(--font-heading)', fontSize: 15, fontWeight: 600 }}>{t('Examen Programme 6', 'Exam Program 6')}</span>
          </div>
          ...
          <motion.div key={current} initial={{ opacity: 0, x: 12 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -12 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              {order.map((originalIdx, displayIdx) => {
                ...
                } else if (isThisSelected) { bg = 'rgba(6, 182, 212, 0.1)'; border = accentColor }
